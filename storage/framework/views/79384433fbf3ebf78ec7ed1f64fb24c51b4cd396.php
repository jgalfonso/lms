<nav id="left-sidebar-nav" class="sidebar-nav">
    <ul id="main-menu" class="metismenu">
        ...
        <li class="<?php echo e(set_nav_status(['admin/dashboard*'])); ?>">
            <a href="<?php echo e(route('dashboard')); ?>"><i class="icon-speedometer"></i><span>Dashboard</span></a>
        </li>
...
<?php /**PATH /Users/alfonsojg/Sites/lms/resources/views/admin/includes/sidebar_nav.blade.php ENDPATH**/ ?>