...
import { getOverview, getAssignments } from "../../../../../helpers/classes";
...
class Main extends Component {
    ...
    static getDerivedStateFromProps(props, state) {
   	...
   	async componentDidMount() {
        ...
        let dt = await getAssignments(classID, this.state.user.access_token);
                            ...
                            <div className="col-md-6 col-sm-12">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item active" aria-current="page">Assignments | {row && row.class_name}</li>
                                    </ol>
                                </nav>
                            </div>   
