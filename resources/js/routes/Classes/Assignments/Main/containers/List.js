            ...
            <div className="col-md-10">
                <div className="single-blog">
                    <div className="post-content overflow" style={{ padding: "0" }}>
                        <h2 className="post-title bold">{row.class_name} - Assignments</h2>
                    </div>
                </div>
                        ...
                        <div className="table-responsive">
                            <table className="table header-border table-hover table-custom spacing5">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>Assignments Overview & Resources</th>
                                ...
                                <tbody>
                                    {
                                        dt && dt.map((data, index) => {
                                            ...
                                            return (
                                                <tr key={index}>
                                                    <th className="w60 text-center"><i className="fa fa- fa-file-text-o"></i></th>
                                                    <td><a href={'/classes/'+classID+'/assignments/'+data.assignment_id}>{data.assignment_title}</a></td>
