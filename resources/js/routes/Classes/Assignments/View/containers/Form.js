...
import { attachAssignment } from "../../../../../helpers/classes";
...
class Form extends Component {
    ...
    handleSubmit = async () => {
        ...
        data.append('assignmentID', dt.assignment_id);
        data.append('assignmentCode', dt.assignment_code);
        data.append('classFolderID', dt.class_folder_id);
        data.append('assignmentFolderID', dt.google_folder_id);

        files.map((file) => {
            data.append('files[]', file);
        });

        await attachAssignment(data, this.props.user.access_token).then(response => {
