                        ...
                        <tbody>
                            {
                                data.attachments && data.attachments.map((data, index) => {
                                    ...
                                    return (
                                        <tr>
                                            <th className="w60 text-center"><i className="fa fa-external-link"></i></th>
                                            <td><a href={data.attachment_embed_link} target="_blank">{data.lesson_attachment_title}</a></td>
                                            <td>{data.lesson_attachment_filename}</td>
