...
import { getOverview, getParticipants } from "../../../../helpers/classes";
...
class Participants extends Component {
    ...
    static getDerivedStateFromProps(props, state) {
   	...
   	async componentDidMount() {
        ...
        let dt = await getParticipants(classID, this.state.user.access_token);
                            ...
                            <div className="col-md-6 col-sm-12">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item active" aria-current="page">Participants | {row && row.class_name}</li>
                                    </ol>
                                </nav>
                            </div>   
