...
@section('title', 'Users - Students (Edit)')
...
@section('content')
	<div class="row clearfix">
        ...
        <form id="form" method="post" novalidate>
                        ...
                        <div class="row">
                             <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly value="{{ $student->control_no }}" style="font-weight: bold;">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input name="registrationNo" type="text" class="form-control" required value="{{ $student->registration_no }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label>Reference No.</label><span style="color: red"> * </span>
                                     <input name="referenceNo" type="text" class="form-control" required value="{{ $student->reference_no }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input name="lastname" type="text" class="form-control" required value="{{ $student->lastname }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input name="firstname" type="text" class="form-control" required value="{{ $student->firstname }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                             ...
                             <div class="col-lg-3">
                                <div class="form-group">
                                    <label>Suffix</label>
                                    <input name="suffix" type="text" class="form-control" value="{{ $student->suffix }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input name="dob" type="text" class="form-control" data-provide="datepicker" data-date-format="dd/mm/yyyy" required value="{{ date('d/m/Y', strtotime($student->dob)) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="form-group">
                                    ...
                                    <input name="pob" type="text" class="form-control" value="{{ $student->pob }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select name="civilStatus" class="form-control" required>
                                        <option value="" selected="">Choose...</option>
                                        <option @if($student->civil_status == 'Single') selected @endif value="Single">Single</option>
                                        <option @if($student->civil_status == 'Married') selected @endif value="Married">Married</option>
                                        <option @if($student->civil_status == 'Divorced') selected @endif value="Divorced">Divorced</option>
                                        <option @if($student->civil_status == 'Widowed') selected @endif value="Widowed">Widowed</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label>Height</label>
                                    <input name="height" type="text" class="form-control" value="{{ $student->height }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label>Weight</label>
                                    <input name="weight" type="text" class="form-control" value="{{ $student->weight }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input name="eyeColor" type="text" class="form-control" value="{{ $student->eye_color }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input name="hairColor" type="text" class="form-control" value="{{ $student->hair_color }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input name="marks" type="text" class="form-control" value="{{ $student->marks }}">
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="permanentAddress" type="text" class="form-control" required value="{{ $student->permanent_address }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="presentAddress"  type="text" class="form-control" value="{{ $student->present_address }}">
                                                </div>
                                            </div>
                                             ...
                                             <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input name="mobile1" type="text" class="form-control" value="{{ $student->mobile_no1 }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input name="mobile2" type="text" class="form-control" value="{{ $student->mobile_no2 }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input name="phone1" type="text" class="form-control" value="{{ $student->phone_no1 }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input name="phone2" type="text" class="form-control" value="{{ $student->phone_no2 }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="email" type="email" class="form-control" required value="{{ $student->email }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label>Name</label>
                                                    <input name="ecName" type="text" class="form-control" value="{{ $student->ec_name }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label>Address</label>
                                                    <input name="ecAddress" type="text" class="form-control" value="{{ $student->ec_address }}">
                                                </div>
                                            </div>
                                             ...
                                             <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input name="ecContact" type="text" class="form-control" value="{{ $student->ec_contact_no }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <input name="profileID" type="hidden" value="{{ $student->profile_id }}">  
        </form>
    </div>
@endsection
...
@section('script')
    ...
    <script src="{{ URL::asset('admin/js/users/students-edit.js') }}"></script>
@endsection
