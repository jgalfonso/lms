...
@section('breadcrumb')
    ...
    <div class="col-md-6 col-sm-12 text-right hidden-xs">
        <a href="/admin/manage-users/faculty/new" class="btn btn-sm btn-primary" title="" style="width: 100px">Add New</a>
    </div>
@endsection
                            ...
                            <div class="accordion-panel" style="display: none;">
                                <div class="row" style="margin-top: 15px; ">
                                    <div class="col-lg-6 col-md-4 col-sm-6">
                                        <label>Filter by Name / Faculty No:</label>
