        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12">
                        ...
                        <div class="card margin-15">
                            <div class="body">
                                <div class="form-group">
                                    <label>Title</label>
                                    <label class="block"><b>{{ $participant->project }}</b></label>
                                </div>
                    ...
                    <input id="participantID" type="hidden" name="participantID" value="{{ $participant->participant_id }}">
                    </form>
                    ...
                    <div class="card">
                        ...
                        <div class="row action-mark">
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('evaluation-project') }}" class="btn btn-danger">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('script')
    ...
    <script src="{{ URL::asset('admin/js/academic/projects/submitted-attachments.js') }}"></script>
@endsection
