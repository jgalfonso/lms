...
@section('breadcrumb')
    ...
    <div class="col-md-6 col-sm-12 text-right">
        <a href="{{ route('new-invoice') }}" class="btn btn-sm btn-primary" title="">New Invoice</a>
    </div>
@endsection
    ...
    <div class="row clearfix">
        ...
        <div class="col-md-12">
            ...
            <div class="row "  style="float: left; margin-top:  10px">
               <div class="col-md-12">
                  <a href="services-billing-payments-new.html" class="btn btn-sm btn-success" style="width: 100px;">Pay</a>
               </div>
           </div>
        </div>
    </div>
