            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#items">Invoices</a></li>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover js-basic-example dataTable table-custom spacing5 mb-0" id="myTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="7">  <button type="button" class="btn btn-default float-right"  data-toggle="modal" data-target="#addClass">Add Invoice</button></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
...
@section('script')
    ...
    <script src="{{ URL::asset('admin/js/billing/new-payment.js') }}"></script>
@endsection
 Payment
