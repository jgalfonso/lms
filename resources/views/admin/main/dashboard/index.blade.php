                    ...
                    <div class="body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <h4 class="mb-0 font-weight-medium">1,040</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <h4 class="mb-0 font-weight-medium">651</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <h4 class="mb-0 font-weight-medium">34</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <h4 class="mb-0 font-weight-medium">980</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="body">
                        <div class="row text-center">
                            <div class="col-6 border-right pb-4 pt-4">
                                ...
                                <h4 class="font-30 font-weight-bold text-col-blue">3,401</h4>
                            </div>
                    ...
                    <table class="table table-hover table-custom spacing5">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Class 1</td>
                                <td><span class="badge badge-success ml-0 mr-0">Active</span></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>Class 2</td>
                                <td><span class="badge badge-danger  ml-0 mr-0">Inactive</span></td>
                                <td>
                                    <button type="button" class="btn btn-sm btn-default" title="Send Invoice" data-toggle="tooltip" data-placement="top"><i class="icon-envelope"></i></button>
                                    <button type="button" class="btn btn-sm btn-default " title="Print" data-toggle="tooltip" data-placement="top"><i class="icon-printer"></i></button>
                                    <button type="button" class="btn btn-sm btn-default" title="Delete" data-toggle="tooltip" data-placement="top"><i class="icon-trash"></i></button>
            ...
            <div class="col-lg-4 col-md-12">
                <a class="card" href="javascript:void(0)">
                    <div class="body text-center">
                        <img class="img-thumbnail rounded-circle" src="assets/images/user.png" alt="">
                        <h6 class="mt-3">Michelle Green</h6>
                        <div class="text-center text-muted">Teacher of the Week</div>
                    </div>
