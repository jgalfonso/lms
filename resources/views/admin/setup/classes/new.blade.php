...
@section('title', 'Setup - Classes (New)')
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="instructorID" class="form-control" required>
                                        ...
                                        @foreach ($faculty as $row)
                                            <option value="{{ $row->profile_id }}">{{ $row->lastname }}, {{ $row->firstname }} {{ $row->middlename }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                   ...
                                   <input name="googleMeetLink" type="text" class="form-control">
                               </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="scheduleTypeID" class="form-control" required>
                                        ...
                                        @foreach ($schedule_types as $row)
                                            <option value="{{ $row->schedule_type_id }}">{{ $row->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
...
@section('script')
    ...
    <script src="{{ URL::asset('admin/js/setup/classes-new.js') }}"></script>
@endsection
