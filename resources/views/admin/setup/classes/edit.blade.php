                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="start" name="start" type="text" class="form-control date" data-provide="datepicker" data-date-format="dd/mm/yyyy" value="@if($class->start) {{ date('d/m/Y', strtotime($class->start)) }} @endif">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3"   >
                                        ...
                                        <input id="end" name="end" type="text" class="form-control date" data-provide="datepicker" data-date-format="dd/mm/yyyy" value="@if($class->end) {{ date('d/m/Y', strtotime($class->end)) }} @endif">
                                    </div>
                                </div>
                            </div>
                        </div>
