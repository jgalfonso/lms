$(function () {
    var table = $('#dt').DataTable({
        ...
        bLengthChange: false,
        columns:[
            { data: 'participantID' , 'className': 'hidden' },
            { data: 'checkbox' },
            { data: 'student' },
            { data: 'title' },
                    ...
                    if (data != '') {
                        ...
                        $.each(data, function (key, row) {
                            ...
                            var checkbox = '<label class="fancy-checkbox text-center">' +
                                                '<input type="checkbox" name="project" class="mark check" value="' + row['participant_id'] + '" id="' + row['participant_id'] + '">' +
                                                '<span></span>' +
                                            '</label>';
                            ...
                            var title = '<a href="' + App.baseUrl + '/view/' + row['project_id'] + '">' + row['project'] + '</a>' + '<br /><b>' + row['class_code'] + '</b>' + '<br />'
                            ...
                            var action = '<a href="' + App.baseUrl + "/submitted-attachments/" + row['participant_id'] +'" class="btn btn-sm btn-default" title="Assess"><i class="icon-eye"></i></a>';
